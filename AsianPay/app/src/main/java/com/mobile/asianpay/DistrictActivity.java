...
import com.mobile.asianpay.adapter.CustomDistrictAdaptor;

public class DistrictActivity extends AppCompatActivity {

    RecyclerView districtRecyclerView;
    LinearLayoutManager layoutManager;
    CustomDistrictAdaptor customDistrictAdaptor;
...
//        fixme 4 init adapter
        customDistrictAdaptor = new CustomDistrictAdaptor(this,data);

//        fixme 4 set adapter
        districtRecyclerView.setAdapter(customDistrictAdaptor);
    }
